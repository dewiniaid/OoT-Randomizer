...
class World(object):
    ...
    def __init__(self, id, settings, resolveRandomizedSettings=True):
        ...
        self.entrance_shuffle = (
            self.shuffle_interior_entrances or settings.shuffle_grotto_entrances
            or settings.shuffle_dungeon_entrances or settings.shuffle_overworld_entrances or settings.owl_drops
        ...
        if (
            settings.open_forest == 'closed' and (
                self.shuffle_special_interior_entrances or settings.shuffle_overworld_entrances
                or settings.warp_songs or settings.spawn_positions or settings.decouple_entrances
                or (settings.mix_entrance_pools != 'off')
                or settings.shuffle_bosses
            )
        ):
